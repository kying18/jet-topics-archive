...
do 
    (
        ...
        do
            ...
            # if [ "$input" == "pp" ]; then
            >/data/kying/lda/${folder_prefix}Results/${tmva}_${input}_pt${minpt}${maxpt}_cwola.root
            root -b -l -q 'RunLD.C("'/data/kying/lda/${folder_prefix}Root/${input}_pt${minpt}${maxpt}'","'/data/kying/lda/${folder_prefix}Root/${tmva}_${input}_pt${minpt}${maxpt}'_cwola.root","'${input}_pt${minpt}${maxpt}_cwola_'","dijet","photonjet")'
            echo "Ran LDA..."
            # fi
            ...
            for suffix in ${suffixes[@]}
            do
                >/data/kying/lda/${folder_prefix}Application/${tmva}_${input}_pt${minpt}${maxpt}${suffix}_cwola.root
                root -b -l -q 'RunLDApplication.C("'/data/kying/lda/${folder_prefix}Root/${input}_pt${minpt}${maxpt}${suffix}.root'","'/data/kying/lda/${folder_prefix}Application/${tmva}_${input}_pt${minpt}${maxpt}${suffix}_cwola.root'","'pp_pt${minpt}${maxpt}_cwola_'")'
            done
            ...
            if [ "$input" == "pp" ]; then
                >/data/kying/lda/${folder_prefix}Csvs/${tmva}_pt${minpt}${maxpt}_cwola.csv
                label_prefix="pp80"
            fi
            ...
            do
                echo $suffix
                ./getTopicModelingCsv.exe -input /data/kying/lda/${folder_prefix}Application/${tmva}_${input}_pt${minpt}${maxpt}_photonjet${suffix}_cwola.root -labels ${label_prefix}_photonjet${suffix} -output /data/kying/lda/${folder_prefix}Csvs/${tmva}_pt${minpt}${maxpt}_cwola.csv
                ./getTopicModelingCsv.exe -input /data/kying/lda/${folder_prefix}Application/${tmva}_${input}_pt${minpt}${maxpt}_dijet${suffix}_cwola.root -labels ${label_prefix}${suffix} -output /data/kying/lda/${folder_prefix}Csvs/${tmva}_pt${minpt}${maxpt}_cwola.csv
            done
        ...
        cp /data/kying/lda/${folder_prefix}Csvs/${tmva}_pt${minpt}${maxpt}_cwola.csv ~/jet-topics/data
        mv ~/jet-topics/data/${tmva}_pt${minpt}${maxpt}_cwola.csv ~/jet-topics/data/${folder_prefix}_${tmva}_pt${minpt}${maxpt}_cwola.csv
    ) &
    let count+=1
    [[ $((count%5)) -eq 0 ]] && wait
done